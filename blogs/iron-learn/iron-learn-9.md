...
### Original Image
![Original Image](${iron-learn-9-original} "Original Image")

### The Initial Static
![Initial Static](${iron-learn-9-plot_static})

### Final Image on 200x200
![Final Reconstruction](${iron-learn-9-plot_final})
...
![Higher Resolution Reconstruction](${iron-learn-9-plot_FINAL_1024})
